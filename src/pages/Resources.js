...
const Resources = () => {
    return(
        <div className="page">
            ...
            <p>Downloadable resources such as brochures, annual reports, and project proposals.
            </p>
            <h3>Research and Publications</h3>
            <p>Studies, research papers, and publications related to Bahaginan’s work.
            </p>
            <h3>Media Kit</h3>
            <p>Logos, photos, and press releases for media use.</p>
